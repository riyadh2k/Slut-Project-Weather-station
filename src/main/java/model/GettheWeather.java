	...
	public static void getWeather(weatherBean wBean) throws IOException {
		...
		for (int temp = 0; temp < nList1.getLength(); temp++) {
			...
			if (node.getNodeType() == Node.ELEMENT_NODE) {
				...
				floatval = (int)(Float.parseFloat(XMLtemperature)-273);
				// and print it
				
				System.out.println(wBean.getCityStr() + " is now  " + floatval + " C");
				// save it
				String floatval1= String.valueOf(floatval);
				wBean.setTemperatureStr(floatval1);
